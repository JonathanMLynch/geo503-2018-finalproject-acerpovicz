...
House loss due to fires in southern Australia have gained more and more media attention in recent years. These fires have been found to be more severe in relation with the amount of "fuel" near the home. This study used data on the amount of brush and other buildings within 40m of homes in southern Australia and the amount of fire fighter responses to fires in this region to illustrate the most significant cause of burnt homes, brush fires or fires starting within homes. This study is intended to look into the current issues at hand, and forcast the near future state of affairs in California.
...
## South Australian Country Fire Service Current Incidents
read.xml("http://www.cfs.sa.gov.au/custom/criimson/CFS_Current_Incidents.xml")

install.packages("XML")
library(XML)
xml("http://www.cfs.sa.gov.au/custom/criimson/CFS_Current_Incidents.xml")

#Materials and Methods

Describe what you are doing and show how to do it (with code).
...
1. All datasets will be imported into R Studio and cleaned. Ggplot will be used to create a simple visual model of homes burnt over time. This graph will provide the basis for further analysis. 
...
https://data.gov.au/dataset/south-australian-country-fire-service-current-incidents-rss-feed
